...
neg_and_done:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF66147A828
    ...
    mov eax, 1
LABEL@AFTER_THEN_00007FF66147A828:

    ;"Else" (part of "ElseIf")
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF66147BCF0
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF66147E258
    ...
    mov eax, 1
LABEL@AFTER_ELSE_00007FF66147BCF0:
LABEL@AFTER_THEN_00007FF66147E258:

    ;"Else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF66147F720
    ...
    ;";" (after "Else")
LABEL@AFTER_ELSE_00007FF66147F720:
    ...
    ;after cond expresion (after "If")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6614841F0
    ...
    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF6614841F0:

    ;"Else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF6614856B8
    ...
    ;";" (after "Else")
LABEL@AFTER_ELSE_00007FF6614856B8:
    ...
    ;after cond expresion (after "If")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF66148A188
    ...
    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF66148A188:

    ;"Else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF66148B650
    ...
    ;";" (after "Else")
LABEL@AFTER_ELSE_00007FF66148B650:
    ...
    ;after cond expresion (after "If")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF66148EC58
    ...
    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF66148EC58:

    ;"Else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF661490120
    ...
    ;";" (after "Else")
LABEL@AFTER_ELSE_00007FF661490120:
