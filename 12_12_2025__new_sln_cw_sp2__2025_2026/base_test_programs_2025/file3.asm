...
LABEL@00000263680FC388:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF66147A400
    ...
    jmp LABEL@00000263680FC388

    ;";"

    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF66147A400:
...
LABEL@00000263680FF498:
    ...
    ;after cond expresion (after "If")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6614820B0
...
LABEL@00000263680FF558:
    ...
    ;after cond expresion (after "If")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF661484E68
    ...
    jmp LABEL@00000263680FF558

    ;";"

    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF661484E68:
    ...
    jmp LABEL@00000263680FF498

    ;";"

    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF6614820B0:
