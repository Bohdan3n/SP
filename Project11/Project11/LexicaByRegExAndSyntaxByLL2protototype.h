...
#define KEYWORDS_RE       ";|->|:|And|\\++|\\*+|Not|Program|Start|Var|,|Finish|Scan|\\[|\\]|\\(|\\)|\\{|\\}|Print|Sub|Div|Mod|Eg|Ne|Le|Ge|Or|Int_4|If|Else|Goto"
...
{LA_IS, { "ident_terminal" }, { "statement", {\
    ...
    { LA_NOT, { T_COLON_0 }, 2, {"expression_or_cond_block__with_optional_assign", T_SEMICOLON_0}}\
}}},\
{LA_IS, { T_IF_0 }, { "statement", {\
    { LA_IS, {""}, 1, {"cond_block"}}\
}}},\
{LA_IS, { "(", T_NOT_0, "unsigned_value_terminal", T_ADD_0, T_SUB_0 }, { "statement", {\
    { LA_IS, {""}, 2, {"expression_or_cond_block__with_optional_assign", T_SEMICOLON_0}}\
}}},\
{LA_IS, { T_GOTO_0 }, { "statement",{\
    {LA_IS, {""}, 2, {"goto_label", T_SEMICOLON_0}}\
}}},\
{LA_IS, { T_INPUT_0 }, { "statement",{\
    {LA_IS, {""}, 2, {"input_rule", T_SEMICOLON_0}}\
}}},\
{LA_IS, { T_OUTPUT_0 }, { "statement",{\
    {LA_IS, {""}, 2, {"output_rule", T_SEMICOLON_0}}\
}}},\
...
{ LA_IS, { T_NAME_0 }, { "program_rule",{\
    { LA_IS, {""}, 9, { T_NAME_0, "program_name", T_SEMICOLON_0, T_BEGIN_0, T_DATA_0, "declaration__optional", T_SEMICOLON_0, "statement__iteration", T_END_0 }}\
}}},\
...
{ LA_IS, { T_NAME_0 }, { "program____part1",{\
    { LA_IS, {""}, 6, { T_NAME_0, "program_name", T_SEMICOLON_0, T_DATA_0, "declaration_optional", T_SEMICOLON_0 }}\
}}},\
\
},\
"program_rule"