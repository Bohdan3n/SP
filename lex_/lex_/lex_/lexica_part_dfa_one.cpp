...
#define TOKENS_RE         "->|\\+\\+|Sub|\\*\\*|Eg|Not|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       ";|->|\\+\\+|Sub|\\*\\*|,|Eg|!=|:|\\[|\\]|\\(|\\)|\\{|\\}|Program|Var|Start|Finish|BREAK|CONTINUE|Scan|Print|If|Else|FOR|TO|DOWNTO|DO|WHILE|REPEAT|UNTIL|Goto|Div|Mod|Le|Ge|Not|And|Or|Int_4"
...
#define DEFAULT_INPUT_FILE "Test_Program1.sh27"
